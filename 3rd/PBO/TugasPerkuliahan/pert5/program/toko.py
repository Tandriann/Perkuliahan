        ...
        if (plh_mn == 1):
            ...
            if (cek != "Tidak Ada"):
                if (voucher[cek]['dipakai']):
                    ...
                    print("Nama : ", b['nama'])
                    print("Dengan Harga : Rp.", b['harga'])
                    print("Anda Juga Mendapat Potongan Sebesar " +
                          str(voucher[cek]['diskon'])+"%")
                    print("Total Harga : Rp.", (b['harga']-potongan))
                    print("Silahkan Bayar Tagihan Sebelum ",
                          trans['batas_waktu'])
                    print("==============================")
...
def bayarTransaksi(no):
    ...
    if (plh_trans == no):
        ...
        if (trans['batas_waktu'] < datetime.datetime.now()):
            ...
            print("====================")
            print(
                "Transaksi Sudah Melebihi Batas Yang Di Tentukan Maka Transaksi Di Anggap Hangus!")
            print("====================")
